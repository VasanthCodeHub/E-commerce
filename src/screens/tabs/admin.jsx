...
const uploadData = async () => {
  let valid = true;
  const newErrors = { category: '', brandName: '', originalCost: '', offerPercentage: '' };
  setErrors(newErrors); 
  setInputError(''); 
  ...
  />
     ...
     <TextInput
         style={[
         styles.inputName,
         errors.originalCost ? styles.inputError : null
    ]}
  ...
  />
     ...
     <TextInput
         style={[
         styles.inputName,
         errors.offerPercentage ? styles.inputError : null
    ]}
